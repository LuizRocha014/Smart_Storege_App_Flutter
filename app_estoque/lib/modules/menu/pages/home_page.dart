          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                filled: true,
                fillColor: CoresDoAplicativo.secundaryColor.withOpacity(0.9), // Cor de fundo similar à da imagem
          ...
          children: [
                  ...
                  itemBuilder: (BuildContext context, int index) => GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: CoresDoAplicativo.branco,
                            border: Border.all(color: CoresDoAplicativo.cinzaIperClato),
                            borderRadius: BorderRadius.circular(20)),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
            ...
            Row(
              ...
              children: [
                ...
                const TextWidget("Ver tudo", textColor: CoresDoAplicativo.cinzaIperClato)
              ],
            ),
            ListView.builder(
              shrinkWrap: true,
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(MediaQuery.of(context).size.height * 0.01),
                            border: Border.all(color: CoresDoAplicativo.secundaryColor),
                          ),
                          child: Image.asset(
                              height: MediaQuery.of(context).size.height * 0.05, AssetsAplicativo.iconItemProduto),
                        ),
                      ),
                      Padding(
